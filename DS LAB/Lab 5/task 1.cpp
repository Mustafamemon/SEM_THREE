...
class linkedlist
{
	...
	public:	
		...
		void delete_somewhere(int ndata)
		{
			if (head!=NULL)
			{
...
linkedlist Bubble_sort(linkedlist List)
{
	int flag=0;
	node *temp=List.return_head() ,*temp1=List.return_head();
	while(temp1!=NULL)
	{
		temp=List.return_head();
		while(temp!=List.return_tail())
		{
